  ...
  return (
    <group position={[0, -0.35, 0]} scale={shoeScale}>
      ...
      <group rotation={[0, -Math.PI / 2, 0]}>
        ...
        {/* Lado Exterior */}
        <NikeSwoosh color={c.swoosh} position={[-0.05, 0.03, 0.04]} rotation={[0.1, -0.1, 0]} scale={0.25} />
        {/* Lado Interior */}
        <NikeSwoosh color={c.swoosh} position={[0.07, 0.03, -0.04]} rotation={[0.1, Math.PI + 0.1, 0]} scale={0.25} />
      </group>
