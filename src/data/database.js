...
export const productos = [
  // ─── INDOOR GEN Z (FÚTBOL DE BARRIO) ───────────────────────────────────────
  {
    ...
    descripcion:
      "Diseñada con el alma del fútbol de barrio: 'El verdadero gol no se marcó en un gran estadio, sino en una cancha improvisada de tierra, donde las mochilas servían de arco y nuestras mamás se convertían en las árbitras; pitando un final inesperado, pero nosotros siempre le decíamos: «¡Una más y nos vamos!».'. Tejido técnico transpirable, gráficos estilo graffiti 'Fútbol Amigos Barrio Sueños' y sellos de autenticidad en Volt y Azul Indoor.",
    precio: 30.00,
    enOferta: false,
    esNuevo: true,
    stock: 50,
